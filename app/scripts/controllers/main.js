...
/**
 * @ngdoc function
 * @name mts.fieldbook.controller:MainCtrl
 * @description
 * # MainCtrl
 * Controller of the mts.fieldbook
 */
angular.module('mts.fieldbook')
  .controller('MainCtrl', ['$firebaseArray','$firebaseObject', '$q','$firebaseAuth','$scope', '$rootScope','$timeout', 'Ref', 'LOCATIONS', 'user', 'Auth', 'ROW','WORKSPACE',
    function ($firebaseArray, $firebaseObject, $q,$firebaseAuth, $scope, $rootScope, $timeout, Ref, LOCATIONS, user, Auth, WORKSPACE, ROW) {
      var newmapdata;
      var newmapdata2;
      var parsedData2;
      var text ="";
      ...
      var map = new google.maps.Map(document.getElementById('map'), {
                  ...
                  center: {lat: 36.435142, lng: -99.192808},
                  zoom: 8,
                  mapTypeId: 'hybrid'
...
overlay.setPosition(coordinate);
  ...
  // map.controls[google.maps.ControlPosition.TOP_RIGHT].push(legend)
          ...
          //       var color;
          //
          //       if (routename === "South 1A"){
          //         stroke = 'red';
          //       }
          //       // if (surveyed !==""){
          //       //   color='green';
          //       // }
          //       else if (surveyapproved !== null &&typeof(surveyapproved)!=="undefined"&&surveyapproved!=="" && surveypermission!==""&&specialconditions ==="YES" ) {
          //         color='yellow';
          //       }
          //       else if (surveyapproved!==null && typeof(surveyapproved)!=="undefined"&&surveyapproved!=='') {
          //         color='#00ff80';
          //       }
          //       else if (surveydenied !=="") {
          //         color='red';
          //       }
          //       else {
          //         color='white';
